...
?>
        <div class="views-field views-field-field-author">
            <div class="field-content">
                <span class="date"><?php echo $posttime; ?></span> | <span class="author"><?php echo ($author[0]->name ? $author[0]->name : 'anonymous')?></span>
            </div>
        </div>
<?php
        echo get_the_post_thumbnail($post);

        if (IsSet($post_meta['wpcf-image']) && IsSet($post_meta['wpcf-image'][0]) && $post_meta['wpcf-image'][0]) {
            echo '<img src="'.$post_meta['wpcf-image'][0].'" />';
        }
        ...
        if(IsSet($post_meta['wpcf-photocreditcaption']) && IsSet($post_meta['wpcf-photocreditcaption'][0]) && $post_meta['wpcf-photocreditcaption'][0]) {
            echo '<span style="margin-left: 190px; margin-top: -10px; position: absolute;">'.$post_meta['wpcf-'][0].'</span>';
        }
        echo '</div>';
