 ...
 */
function thecipherbrief_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'thecipherbrief_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.thecipherbrief-front-page) .entry-title,
...
.colors-custom .thecipherbrief-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.thecipherbrief-front-page .panel-content .recent-posts article,
...
.colors-custom.thecipherbrief-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'thecipherbrief_custom_colors_css', $css, $hue, $saturation );
}
